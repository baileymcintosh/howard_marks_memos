...
firm: "oaktree"
url: "https://www.oaktreecapital.com/docs/default-source/memos/2015-06-08-risk-revisited-again.pdf?sfvrsn=7bb70f65_8"
...
Revisited”
of September 2014 for inclusion in a compilation of my memos, I thought of a number of ways
in which it could be made better.  And since it was my original intention to have it contain everything I
know about risk, I’ve decided to incorporate them.
To make it clear which sections are new, I’ve put
them in italics.

In April 2014, I had good results with Dare to Be Great II,
starting from the base established in an earlier
...
However, while volatility is quantifiable and machinable – and can
be an indicator or symptom of
...
rain.
It can be modeled, and it can be estimated (and by experts pretty well), but it cannot be known.
...
any assistance whatever from intuition or direct judgment. . .
...
conducted, you have not thereby imposed a limit on the nature of events so that in the
...
“But
only for the most part” is what risk is all about: uncertainty.  The key hazard of
...
Only then can we develop an answer to the question of whether, in today’s
global
...
its own destruction.”
All of history testifies to the truth of this observation.  Greater
...
Beginning on page 9, you’ll find a section borrowed
from a memo I wrote back in 2007.  Its first bullet
...
But there’s good reason why economics is called “the dismal science,” and in fact it isn’t
much of
...
you just can’t say for sure that “if A, then B,”
...
quantitative (even if it’s expressed in numbers).

There’s little I believe in more than
Albert Einstein’s observation: “Not everything that counts can be
...
By the way, in
my personal life I tend to incorporate another of Einstein’s comments: “I never think of the
...
In other words, in order to achieve superior results, an investor must be able –
...
company’s
earnings and the valuation of those earnings meet our targets, the return will be as expected.
...
(investors’ valuation
of the earnings) also meets expectations, the result should be a rising share price,
...
probabilities doesn’t mean you know what’s going to happen.  For example, all good backgammon
...
investors’ opinions regarding future return, not facts.  Risky investments are – by definition –
far from
...
Lessons of ’07” (December 2007).
It points out some of the ways in which risk deviates in practice from
...
of history to the future is much more limited than many believe to be the case.
[Along these same
...
 Decisions whether or not to bear risk are made in contemplation of normal patterns recurring, and
...
 Risk shows up lumpily.  If we say “2% of mortgages default each year,”
and even if that’s true when
...
especially those who employ high leverage –
