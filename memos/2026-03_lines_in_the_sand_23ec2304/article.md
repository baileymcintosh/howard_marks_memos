...
firm: "oaktree"
url: "https://www.oaktreecapital.com/docs/default-source/memos/lines-in-the-sand.pdf?sfvrsn=bf5dfa65_2"
...
effect.  Thus I decided to write this
memo on the topic for general circulation.

How Do Subscription Lines Work?

As I wrote in the year-end review, subscription lines are bank loans
extended to funds that enable
them to use borrowed money, rather than LP capital, to make early investments or pay fees and
expenses.  While there is no universal description, I believe it’s
safe to say in general that
subscription lines:
...
lever funds in the sense of allowing funds to invest more than their committed capital.
Fund-
...
Also, the use of a subscription line – obviously –
doesn’t alter the fund’s committed or invested
...
So much for what isn’t changed.  The question, then, is “what is?”
First the positives:
...
 With calls for LP capital postponed,
the reported Internal Rate of Return or IRR in the
...
 If
a fund finances investments by borrowing under a subscription line, interest and
...
in dollar profits (see above).  Thus it eats into the fund’s dollar lifetime gains as well as its
multiple of capital.
...
sooner,
although it will have no effect on the amount of incentive fees ultimately paid by a
...
 Less disciplined or less diligent GPs
may be induced to lower the standards to which
...
The most important question in assessing fund performance is clear:
Did the GP do a good job?
...
But the deeper message was that, while valuable, neither IRR
nor MOCC nor MOC – nor any
...
To understand what an IRR
really says about fund performance, you have to know
...
result in proceeds of $40 million and thus an MOC
of 4x.  That’s great for the LPs . . . as far
as it goes.  But if that’s the only investment the GP makes, the LPs collectively will earn

profits of only $30 million, certainly not what they had in mind when they committed $100
...
may look better on one of them and Fund B on another.
So this is really just one more way in which
...
job – or made its LPs as much money –
as one that didn’t use a line (or used a line less
...
 The GP
organizes a fund and arranges for a subscription line.
 LPs commit capital.
...
idealized progression.  Most of these would be the result of negative
