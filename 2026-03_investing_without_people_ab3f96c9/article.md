...
firm: "oaktree"
url: "https://www.oaktreecapital.com/docs/default-source/memos/investing-without-people.pdf?sfvrsn=7a5ec465_8"
downloaded: "2026-03-24"
images: []
---

devoted three memos to discussing macro developments, market
...
and (c) artificial intelligence and machine learning.
...
And then there was the empirical evidence that
for decades most mutual funds had performed behind
...
logic was clear and convincing, per the following citation from Wikipedia (with apologies to Richard
...
mutual fund is noticed, fund spokesmen are quick to point out “
You
...
effective in 1972.  I have no reason to believe it
attracted many investors.

But then Jack Bogle formed the Vanguard Group in 1974, and Vanguard’s
First Index Investment
Trust went operational on the last day of 1975.

At the time, it was heavily derided by competitors as being “un
-American” and the
...
investor’s active managers.  As they did with many potential alternatives to traditional
stock and
bond investing – such as emerging market stocks, private equity, venture capital, high yield bonds,
distressed debt, timber and precious metals –
some institutions put a smattering of capital into index
funds, but rarely enough to meaningfully alter the performance of their overall portfolios.  Few

institutions if any made passive investing a substantial part of their portfolios: thus it added a little
...
Index Fund now stands at $410 billion).
According to data from Morningstar, roughly similar
...
Given the L.A. Times
quote above, I want now to introduce ETFs, or exchange-traded funds.  In the
...
close of trading each day, when the daily closing net asset value (or NAV) is
calculated, ETFs can be
...
In
the late 20th century, “index investing” and “passive investing” were synonymous: vehicles
...
But what does “passive” mean when a vehicle’s focus is defined so narrowly?  Each
...
the characteristics listed above.  (“There They Go Again . . . Again
” July 2017)
...
That’s the background.  Now I’m going to turn to the implications
...
or portfolio weightings?  Certainly not.  But passive investing dispenses with this
concern by
...
capitalizations that determine the index weightings of securities that index funds emulate.  If
...
passively?
Then prices will be freer to diverge from “fair,” and bargains (and over-
...
picture a world in which nobody’s
studying companies or assessing their stocks’ fair value?  I’d
...
The third
key question is: “Does passive and index investing distort stock prices?”  This is an
...
in the index to rise relative to the rest.  I think
the answer is “no.”  Suppose the market capitalizations
...
The third level concerns stocks in smart-beta funds.  The more a stock is held in non-index passive
...
Might the inclusion and overweighting in ETFs of market darlings –
a source of demand that may
...
“Can the process of investing in indices be improved relative to simply
...
First, as I wrote in “Liquidity
” (March 2015), the fact that something is able to be sold legally, or the
...
Some people may have invested
in ETFs in the mistaken belief that they’re inherently more liquid
...
(which themselves are likely to become quite illiquid)?
The weakness lies in the assumption that a
...
managed by Matt Pasts, which on February 9 went from “almost entirely in junk bonds”
to fully in
cash:
...
investing almost entirely via ETFs.  In late January, before it sold, BTS had about
...
investors to
participate in the markets – assembling portfolios that mimic the indices and “free-
riding” on the work and price discovery performed by active investors – without picking up their
share of the analytical tab.

But that misses
the reality behind George Soros’s Theory of Reflexivity: that the actions of market
...
My next topic –
which, as I said, I’m just learning about (and thus I write with some trepidation) –
...
appreciation (or “momentum”).  Thus the manager concludes that his portfolio should consist
...
oil companies.
 Then the manager tells the computer in what proportion to weight the search criteria,
and the
...
is instructed to assess the attendant risk.  The portfolio is optimized,
...
The end product of this process is a
portfolio that, according to the algorithm, will deliver the highest
...
The other main form of quantitative investing is “statistical arbitrage” or “stat arb.”
For an
...
“idiosyncratic” – related to that one stock –
rather than “systematic,” or present throughout
the market.
...
 Thus the computer decides the quant
should “short” stock (sell stock the quant doesn’t own)
to the buyer who’s elevating its price, on the assumption that the quant will be able to cover

later, when the buying has stopped and the price has receded.  It might be possible to sell
...
“Dare to be Great
” (September 2006), and ironically it’s extremely relevant to the question raised
above:
...
performance, but I’m convinced such a formula cannot exist.  According to one of my
...
Of course there can’t be a roadmap to investment success.
...
who succeed at them.
I include here active trading, macro investing and quantitative investing.  As
...
It
seems obvious that a formula’s application and popularization eventually will bring an end
